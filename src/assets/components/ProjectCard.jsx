...
const ProjectCard = ({
  ...
  return (
    <div className="flex flex-col h-[450px] w-[300px] border-2 border-[var(--imp-text-color)] rounded-lg shadow-md shadow-pink-300/20 transition-all duration-300 ease-in-out  px-3 py-5 text-white text-xl">
      <div className="text-center text-white text-2xl mb-1 ">{title}</div>
      <img
        src={image}
        alt="Project"
      ...
      <div className="text-white text-[15px] mt-1">{children}</div>
